package fr.chocolateroad.product.web.rest.errors;

import fr.chocolateroad.product.ProductApp;
import fr.chocolateroad.product.config.SecurityBeanOverrideConfiguration;
